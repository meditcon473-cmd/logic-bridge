 ...
 */
export const METAPHOR_PROMPT = `【隐喻全息解码器 v2.0】
 ...
 */
export const PHENOMENON_PROMPT = `【社会现象透视仪 v2.0】
 ...
 */
export const DIALECTICAL_PROMPT = `【双星引力引擎 v2.0】
 ...
 */
export const SYNTHESIS_PROMPT = `【聚将成帅总指挥 v2.0】
